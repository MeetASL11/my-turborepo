...
import CSSGradientGeneratorForm from '@/app/(default)/tools/(css-tools)/css-gradient-generator/_css-gradient-generator-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('css-gradient-generator')
...
export default function CSSGradientGenerator() {
    const toolDetail = helper.getToolObjectFromSlug('css-gradient-generator')
