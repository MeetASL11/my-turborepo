...
import CSSTriangleGeneratorForm from '@/app/(default)/tools/(css-tools)/css-triangle-generator/_css-triangle-generator-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('css-triangle-generator')
...
export default function CSSTriangleGenerator() {
    const toolDetail = helper.getToolObjectFromSlug('css-triangle-generator')
