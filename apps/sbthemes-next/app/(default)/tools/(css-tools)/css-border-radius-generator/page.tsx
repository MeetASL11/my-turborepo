...
import CSSBorderRadiusGeneratorForm from '@/app/(default)/tools/(css-tools)/css-border-radius-generator/_css-border-radius-generator-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('css-border-radius-generator')
