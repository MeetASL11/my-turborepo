...
import CSSCubicBezierGeneratorForm from '@/app/(default)/tools/(css-tools)/css-cubic-bezier-generator/_css-cubic-bezier-generator-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('css-cubic-bezier-generator')
