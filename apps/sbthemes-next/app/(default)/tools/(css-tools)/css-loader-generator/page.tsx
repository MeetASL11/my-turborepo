...
import CSSLoaderGeneratorForm from '@/app/(default)/tools/(css-tools)/css-loader-generator/_css-loader-generator-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('css-loader-generator')
