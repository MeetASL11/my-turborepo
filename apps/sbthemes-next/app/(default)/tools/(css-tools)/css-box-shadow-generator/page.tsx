...
import CSSBoxShadowGeneratorForm from '@/app/(default)/tools/(css-tools)/css-box-shadow-generator/_css-box-shadow-generator-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('css-box-shadow-generator')
...
export default function CSSBoxShadowGenerator() {
    const toolDetail = helper.getToolObjectFromSlug('css-box-shadow-generator')
