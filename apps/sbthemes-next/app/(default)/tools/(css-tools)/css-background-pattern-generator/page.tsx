...
import CSSBackgroundPatternGeneratorForm from '@/app/(default)/tools/(css-tools)/css-background-pattern-generator/_css-background-pattern-generator-form'
    ...
    return (
        <>
            <div>
                ...
                <CSSBackgroundPatternGeneratorForm />
