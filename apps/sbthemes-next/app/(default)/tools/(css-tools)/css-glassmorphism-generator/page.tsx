...
import CssGlassmorphismGeneratorForm from '@/app/(default)/tools/(css-tools)/css-glassmorphism-generator/_css-glassmorphism-generator-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('css-glassmorphism-generator')
