...
import HashTextForm from '@/app/(default)/tools/hash-text/_hash-text-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('hash-text')
...
export default function HashText() {
    const toolDetail = helper.getToolObjectFromSlug('hash-text')
