...
import Base64StringConverterForm from '@/app/(default)/tools/base64-string-converter/_base64-string-converter-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('base64-string-converter')
...
export default function Base64StringConverter() {
    const toolDetail = helper.getToolObjectFromSlug('base64-string-converter')
