...
import TextGeneratorForm from '@/app/(default)/tools/lorem-ipsum-text-generator/_text-generator-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('lorem-ipsum-text-generator')
...
export default LoremIpsumTextGenerator
