...
import RedirectTrackerForm from '@/app/(default)/tools/redirect-tracker/_redirect-tracker-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('redirect-tracker')
...
export default async function RedirectTracker() {
    const toolDetail = helper.getToolObjectFromSlug('redirect-tracker')
