...
import CaseConverterForm from '@/app/(default)/tools/case-converter/_case-converter-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('case-converter')
...
function CaseConverter() {
    const toolDetail = helper.getToolObjectFromSlug('case-converter')
