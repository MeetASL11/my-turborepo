...
import SSLCheckerForm from '@/app/(default)/tools/ssl-checker/_ssl-checker-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('ssl-checker')
...
const SSLChecker = () => {
    const toolDetail = helper.getToolObjectFromSlug('ssl-checker')
