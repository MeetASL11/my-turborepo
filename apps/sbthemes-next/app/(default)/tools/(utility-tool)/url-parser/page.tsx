...
import URLParserForm from '@/app/(default)/tools/(utility-tool)/url-parser/_url-parser-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('url-parser')
...
export default function URLParser() {
    const toolDetail = helper.getToolObjectFromSlug('url-parser')
