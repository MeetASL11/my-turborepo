...
import PasswordGeneratorBlock from '@/app/(default)/tools/(utility-tool)/password-generator/_password-generator'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('password-generator')
...
export default function PasswordGenerator() {
    const toolDetail = helper.getToolObjectFromSlug('password-generator')
