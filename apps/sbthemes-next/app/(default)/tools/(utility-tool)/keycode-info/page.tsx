...
import KeycodeInfoBlock from '@/app/(default)/tools/(utility-tool)/keycode-info/_keycode-info-block'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('keycode-info')
...
export default function KeycodeInfo() {
    const toolDetail = helper.getToolObjectFromSlug('keycode-info')
