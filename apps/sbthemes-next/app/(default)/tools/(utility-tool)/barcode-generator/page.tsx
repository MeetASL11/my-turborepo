...
import BarcodeGeneratorForm from '@/app/(default)/tools/(utility-tool)/barcode-generator/_barcode-generator-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('barcode-generator')
...
function BarcodeGenerator() {
    const toolDetail = helper.getToolObjectFromSlug('barcode-generator')
