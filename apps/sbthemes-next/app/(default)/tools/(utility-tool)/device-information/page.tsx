...
import DeviceInformationBlock from '@/app/(default)/tools/(utility-tool)/device-information/_device-information-block'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('device-information')
...
function DeviceInformation() {
    const toolDetail = helper.getToolObjectFromSlug('device-information')
