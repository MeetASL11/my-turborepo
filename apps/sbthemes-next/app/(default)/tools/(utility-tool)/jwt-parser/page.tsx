...
import JWTParserBlock from '@/app/(default)/tools/(utility-tool)/jwt-parser/_jwt-parser-block'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('jwt-parser')
...
export default function JWTParser() {
    const toolDetail = helper.getToolObjectFromSlug('jwt-parser')
