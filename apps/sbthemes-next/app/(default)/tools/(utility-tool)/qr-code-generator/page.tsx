...
import QRCodeGeneratorForm from '@/app/(default)/tools/(utility-tool)/qr-code-generator/_qr-code-generator-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('qr-code-generator')
...
function QRCodeGenerator() {
    const toolDetail = helper.getToolObjectFromSlug('qr-code-generator')
