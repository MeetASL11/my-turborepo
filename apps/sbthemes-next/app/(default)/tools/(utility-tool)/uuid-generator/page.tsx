...
import UUIDGeneratorBlock from '@/components/tools/uuid-generator/uuid-generator-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('uuid-generator')
...
function UUIDGenerator() {
    const toolDetail = helper.getToolObjectFromSlug('uuid-generator')
