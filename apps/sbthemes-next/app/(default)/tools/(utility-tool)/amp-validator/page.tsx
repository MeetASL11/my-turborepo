...
import AMPValidatorForm from '@/app/(default)/tools/(utility-tool)/amp-validator/_amp-validator-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('amp-validator')
...
function AMPValidator() {
    const toolDetail = helper.getToolObjectFromSlug('amp-validator')
