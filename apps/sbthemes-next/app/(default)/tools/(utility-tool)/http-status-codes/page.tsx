...
import HttpStatusCodesBlock from '@/app/(default)/tools/(utility-tool)/http-status-codes/_http-status-codes-block'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('http-status-codes')
...
export default function HttpStatusCodes() {
    const toolDetail = helper.getToolObjectFromSlug('http-status-codes')
