...
import ListRandomizerForm from '@/app/(default)/tools/(utility-tool)/list-randomizer/_list-randomizer-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('list-randomizer')
...
function ListRandomizer() {
    const toolDetail = helper.getToolObjectFromSlug('list-randomizer')
