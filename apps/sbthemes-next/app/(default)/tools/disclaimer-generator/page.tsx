...
import DisclaimerGenerateForm from '@/app/(default)/tools/disclaimer-generator/_disclaimer-generator-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('disclaimer-generator')
...
const DisclaimerGenerate = () => {
    const toolDetail = helper.getToolObjectFromSlug('disclaimer-generator')
...
export default DisclaimerGenerate
