...
import HTMLDecodeForm from '@/app/(default)/tools/html-decode/_html-decode-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('html-decode')
...
function HTMLDecode() {
    const toolDetail = helper.getToolObjectFromSlug('html-decode')
