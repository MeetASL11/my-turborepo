...
import MetaTagForm from '@/components/tools/meta-tags-generator/meta-tag-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('meta-tags-generator')
...
export default function MetaTagsGenerator() {
    const toolDetail = helper.getToolObjectFromSlug('meta-tags-generator')
