...
import RefundPolicyGenerateForm from '@/app/(default)/tools/refund-policy-generator/_refund-policy-generate-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('refund-policy-generator')
...
const RefundPolicyGenerate = () => {
    const toolDetail = helper.getToolObjectFromSlug('refund-policy-generator')
...
export default RefundPolicyGenerate
