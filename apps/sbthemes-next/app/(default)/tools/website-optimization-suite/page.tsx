...
import WebsiteOptimizationSuiteGenerator from '@/app/(default)/tools/website-optimization-suite/_website-optimization-suite-generator'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('website-optimization-suite')
...
const WebsiteOptimizationSuite = () => {
    ...
    return (
        <>
            ...
            <WebsiteOptimizationSuiteGenerator />
...
export default WebsiteOptimizationSuite
