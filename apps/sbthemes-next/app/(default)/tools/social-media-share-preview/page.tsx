...
import SocialMediaSharePreviewGenerator from '@/app/(default)/tools/social-media-share-preview/_social-media-share-preview-generator'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('social-media-share-preview')
    ...
    return (
        <>
            <div>
                ...
                <SocialMediaSharePreviewGenerator />
...
export default SocialMediaSharePreview
