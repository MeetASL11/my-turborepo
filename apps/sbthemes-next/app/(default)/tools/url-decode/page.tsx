...
import URLDecodeForm from '@/app/(default)/tools/url-decode/_url-decode-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('url-decode')
...
function URLDecode() {
    const toolDetail = helper.getToolObjectFromSlug('url-decode')
