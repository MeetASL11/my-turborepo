...
import SiteMapValidator from '@/app/(default)/tools/sitemap-validator/_sitemap-validator'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('sitemap-validator')
...
const SiteMapValidatorPage = () => {
    const toolDetail = helper.getToolObjectFromSlug('sitemap-validator')
