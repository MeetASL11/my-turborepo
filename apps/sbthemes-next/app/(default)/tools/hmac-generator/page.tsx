...
import HmacGeneratorForm from '@/app/(default)/tools/hmac-generator/_hmac_generator_form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('hmac-generator')
...
export default function HmacGenerator() {
    const toolDetail = helper.getToolObjectFromSlug('hmac-generator')
