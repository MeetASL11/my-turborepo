...
import TermsAndConditionsGenerateForm from '@/app/(default)/tools/terms-and-conditions-generator/_terms-and-conditions-generate-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug(
...
const TermsAndConditionsGenerate = () => {
    ...
    return (
        <>
            <div>
                ...
                <TermsAndConditionsGenerateForm />
...
export default TermsAndConditionsGenerate
