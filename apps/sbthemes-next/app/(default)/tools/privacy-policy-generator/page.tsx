...
import PrivacyPolicyGenerateForm from '@/app/(default)/tools/privacy-policy-generator/_privacy-policy-generate-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('privacy-policy-generator')
...
const PrivacyPolicyGenerate = () => {
    const toolDetail = helper.getToolObjectFromSlug('privacy-policy-generator')
...
export default PrivacyPolicyGenerate
