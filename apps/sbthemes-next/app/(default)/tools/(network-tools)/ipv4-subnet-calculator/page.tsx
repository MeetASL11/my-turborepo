...
import IPV4SubnetCalculatorForm from '@/app/(default)/tools/(network-tools)/ipv4-subnet-calculator/_ipv4-subnet-calculator-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('ipv4-subnet-calculator')
...
function IPv4SubnetCalculator() {
    const toolDetail = helper.getToolObjectFromSlug('ipv4-subnet-calculator')
