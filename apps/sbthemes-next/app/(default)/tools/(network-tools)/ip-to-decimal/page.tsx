...
import IPToDecimalForm from '@/app/(default)/tools/(network-tools)/ip-to-decimal/_ip-to-decimal-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('ip-to-decimal')
...
function IPToDecimal() {
    const toolDetail = helper.getToolObjectFromSlug('ip-to-decimal')
