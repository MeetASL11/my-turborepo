...
import NSLookupForm from '@/app/(default)/tools/(network-tools)/ns-lookup/_ns-lookup-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('ns-lookup')
...
function NSLookup() {
    const toolDetail = helper.getToolObjectFromSlug('ns-lookup')
