...
import PortCheckerForm from '@/app/(default)/tools/(network-tools)/port-checker/_port-checker-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('port-checker')
...
function PortChecker() {
    const toolDetail = helper.getToolObjectFromSlug('port-checker')
