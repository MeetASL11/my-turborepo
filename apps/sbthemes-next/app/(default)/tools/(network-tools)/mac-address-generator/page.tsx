...
import MAcAddressGeneratorForm from '@/app/(default)/tools/(network-tools)/mac-address-generator/_mac-address-generator-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('mac-address-generator')
...
function MACAddressGenerator() {
    const toolDetail = helper.getToolObjectFromSlug('mac-address-generator')
