...
import CNAMECheckerForm from '@/app/(default)/tools/(network-tools)/cname-checker/_cname-checker-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('cname-checker')
...
function CNAMEChecker() {
    const toolDetail = helper.getToolObjectFromSlug('cname-checker')
