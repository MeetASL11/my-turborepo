...
import IPV6UlaGeneratorForm from '@/app/(default)/tools/(network-tools)/ipv6-ula-generator/_ipv6-ula-generator-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('ipv6-ula-generator')
...
function IPV6UlaGenerator() {
    const toolDetail = helper.getToolObjectFromSlug('ipv6-ula-generator')
