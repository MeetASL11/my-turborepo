...
import DKIMRecordCheckerForm from '@/app/(default)/tools/(network-tools)/dkim-record-checker/_dkim-record-checker-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('dkim-record-checker')
...
function DKIMRecordChecker() {
    const toolDetail = helper.getToolObjectFromSlug('dkim-record-checker')
...
export default DKIMRecordChecker
