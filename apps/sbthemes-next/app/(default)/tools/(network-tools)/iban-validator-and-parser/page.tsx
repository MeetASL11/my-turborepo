...
import IBANValidatorAndParserForm from '@/app/(default)/tools/(network-tools)/iban-validator-and-parser/_iban-validator-and-parser-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('iban-validator-and-parser')
...
function IBANValidatorAndParser() {
    const toolDetail = helper.getToolObjectFromSlug('iban-validator-and-parser')
...
export default IBANValidatorAndParser
