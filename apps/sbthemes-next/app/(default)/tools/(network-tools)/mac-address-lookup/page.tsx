...
import MACAddressLookupForm from '@/app/(default)/tools/(network-tools)/mac-address-lookup/_mac-address-lookup-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('mac-address-lookup')
...
function MACAddressLookup() {
    const toolDetail = helper.getToolObjectFromSlug('mac-address-lookup')
