...
import IPv4AddressConverterForm from '@/app/(default)/tools/(network-tools)/ipv4-address-converter/_ipv4-address-converter-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('ipv4-address-converter')
...
function IPv4AddressConverter() {
    const toolDetail = helper.getToolObjectFromSlug('ipv4-address-converter')
