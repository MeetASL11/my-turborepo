...
import DMARCRecordForm from '@/app/(default)/tools/(network-tools)/dmarc-record/_dmarc-record-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('dmarc-record')
...
function DMARCRecord() {
    const toolDetail = helper.getToolObjectFromSlug('dmarc-record')
