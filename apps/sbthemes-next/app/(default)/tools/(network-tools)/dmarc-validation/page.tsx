...
import DMARCValidationForm from '@/app/(default)/tools/(network-tools)/dmarc-validation/_dmarc-validation-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('dmarc-validation')
...
function DMARCValidation() {
    const toolDetail = helper.getToolObjectFromSlug('dmarc-validation')
...
export default DMARCValidation
