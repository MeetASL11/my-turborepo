...
import URLEncodeForm from '@/app/(default)/tools/url-encode/_url-encode-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('url-encode')
...
function URLEncode() {
    const toolDetail = helper.getToolObjectFromSlug('url-encode')
