...
import SlugConvertForm from '@/app/(default)/tools/text-to-slug-convert/_slug-convert-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('text-to-slug-convert')
...
function TextToSlug() {
    const toolDetail = helper.getToolObjectFromSlug('text-to-slug-convert')
