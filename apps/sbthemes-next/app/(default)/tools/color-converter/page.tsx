...
import ColorConverterForm from '@/app/(default)/tools/color-converter/_color-converter-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('color-converter')
...
function ColorConverter() {
    const toolDetail = helper.getToolObjectFromSlug('color-converter')
