...
import UTMBuilderForm from '@/app/(default)/tools/utm-builder/_utm-builder-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('utm-builder')
...
function UTMBuilder() {
    const toolDetail = helper.getToolObjectFromSlug('utm-builder')
