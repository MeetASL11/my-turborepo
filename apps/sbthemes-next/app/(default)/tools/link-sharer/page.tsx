...
import LinkSharerForm from '@/app/(default)/tools/link-sharer/_link-sharer-form'
import SimilarToolBlock from '@/components/tools/similar-tool-block'
import helper from '@/lib/helper'

export async function generateMetadata(): Promise<Metadata> {
    const metadata = helper.getToolObjectFromSlug('link-sharer')
...
export default function LinkSharer() {
    const toolDetail = helper.getToolObjectFromSlug('link-sharer')
